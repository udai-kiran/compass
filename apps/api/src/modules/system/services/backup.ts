...
export const ALL_TABLES = [
  ...
  "vehicle_details", "vehicle_odometer_readings",
...
export const USER_TABLES: Record<string, string> = {
  ...
  vehicle_details: "user_id", vehicle_odometer_readings: "user_id",
  ...
  ai_settings: "user_id",
  card_details: "user_id", reward_point_lots: "user_id", card_issuer_settings: "user_id", reward_rules: "user_id", card_statements: "user_id",
  ...
  catalog_items: "user_id", price_sources: "user_id", serviceability_checks: "user_id",
