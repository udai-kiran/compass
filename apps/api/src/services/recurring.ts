...
import { emiDetails, recurringTemplates, transactions } from "../db/schema.ts";
import { HttpError } from "../lib/errors.ts";
import { lockAccountPair, stepAmortization } from "./emis.ts";
...
export async function createTemplate(
  ...
  // created together in one transaction by createEmi (see services/emis.ts).
